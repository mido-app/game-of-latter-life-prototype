...
/// <summary>
/// BGMやSEなどのオーディオファイルの再生や停止を管理するクラスです
/// SingletonMonoBehaviour のためスクリプトからは初期化せずに自由に呼び出しできます
/// Doc SingletonMonoBehaviour : http://unity.clockstone.com/audiotoolkitreference/html/T_SingletonMonoBehaviour_1.htm
/// </summary>
/// <example>
/// 使い方
/// A. 音をならしたい時
/// <c>AudioController.Instance.PlaySE("SEファイル名");</c>
/// <c>AudioController.Instance.PlayBGM("BGMファイル名");</c>
///
/// B. 流れている BGM をフェードアウトさせる
/// <c>AudioController.Instance.FadeOutBGM()</c>
///
/// C. 流れている BGM をフェードアウト無しでとめる
/// <c>AudioController.Instance.StopBGM()</c>
///
/// D. 音量を変えたい時
/// BGM, SE の順に 0~1 の値で指定
/// <c>AudioController.Instance.ChangeVolume(0, 0.7)</c>
/// </example>
/// セットアップ
/// gameObject に紐づけて使用する。
public class AudioController : SingletonMonoBehaviour<AudioController>
{
    ...
    public void Awake()
    {
        ...
        // シーンをまたいでも AudioController がアタッチされているゲームオブジェクトを削除しないようにする
